...
public class MultiTenancyAutoConfigure {
    ...
    @ConditionalOnProperty(prefix = "multi.tenancy", value = "sql-auto-add-filters", havingValue = "true")
    ...
    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnProperty(prefix = "multi.tenancy", value = "sql-check-filters-exist", havingValue = "true")
